...
- **Strict Testing Invariants & Failure-First Enumeration**: Mandates "Never write unit tests after code", enumerating failure modes before implementing happy-path logic, and producing repeatable E2E artifacts for complex flows.
